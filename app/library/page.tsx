...
import { mockLessons, type ExperienceLevel } from "@/lib/mock-data";
...
export default function LibraryPage() {
  ...
  const categories = useMemo(() => {
    const unique = Array.from(new Set(mockLessons.map((l) => l.category)));
    return ["All", ...unique];
  }, []);
  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-16">
      <p className="gutter-line mb-4">{`// ${mockLessons.length} lessons and counting`}</p>
